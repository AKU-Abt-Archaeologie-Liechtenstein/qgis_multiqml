...
#
# Created: Fri May 09 23:25:21 2014
...
class Ui_MultiQmlForm(object):
    def setupUi(self, MultiQmlForm):
        MultiQmlForm.setObjectName(_fromUtf8("MultiQmlForm"))
        ...
        self.rbnRasterLayers.setObjectName(_fromUtf8("rbnRasterLayers"))
        self.gridLayout.addWidget(self.rbnRasterLayers, 0, 1, 1, 1)
        self.rbnVectorLayers = QtGui.QRadioButton(MultiQmlForm)
        self.rbnVectorLayers.setObjectName(_fromUtf8("rbnVectorLayers"))
        ...
        self.checkMakeDefault.setObjectName(_fromUtf8("checkMakeDefault"))
