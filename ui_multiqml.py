...
#
# Created: Wed Jan  7 22:38:45 2009
...
class Ui_MultiQmlForm(object):
    def setupUi(self, MultiQmlForm):
        ...
        MultiQmlForm.resize(896, 514)
        self.horizontalLayout_2 = QtGui.QHBoxLayout(MultiQmlForm)
        ...
        self.pbnDefaultStyle = QtGui.QPushButton(MultiQmlForm)
        ...
        self.chbxSelectAllLayers = QtGui.QCheckBox(MultiQmlForm)
        ...
        self.lvTransparency = QtGui.QListView(MultiQmlForm)
        ...
        self.vslValueTransparency = QtGui.QSlider(MultiQmlForm)
        ...
        self.label_3 = QtGui.QLabel(MultiQmlForm)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 5, 1, 1, 1)
        self.sbxValueTransparency = QtGui.QSpinBox(MultiQmlForm)
        ...
        self.canvasFrame = QtGui.QFrame(MultiQmlForm)
        ...
        MultiQmlForm.setTabOrder(self.pbnLoadStyle, self.lvRasterLayers)
        MultiQmlForm.setTabOrder(self.lvRasterLayers, self.pbnDefaultStyle)
        MultiQmlForm.setTabOrder(self.pbnDefaultStyle, self.pbnLoadColormapFromBand)
        MultiQmlForm.setTabOrder(self.pbnLoadColormapFromBand, self.pbnClose)
        MultiQmlForm.setTabOrder(self.pbnClose, self.lvTransparency)
        MultiQmlForm.setTabOrder(self.lvTransparency, self.vslValueTransparency)

    def retranslateUi(self, MultiQmlForm):
        MultiQmlForm.setWindowTitle(QtGui.QApplication.translate("MultiQmlForm", "Dialog", None, QtGui.QApplication.UnicodeUTF8))
        self.pbnLoadStyle.setText(QtGui.QApplication.translate("MultiQmlForm", "Load Style ...", None, QtGui.QApplication.UnicodeUTF8))
        self.pbnDefaultStyle.setText(QtGui.QApplication.translate("MultiQmlForm", "Restory Default Style", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label.setText(QtGui.QApplication.translate("MultiQmlForm", "Raster Layers:", None, QtGui.QApplication.UnicodeUTF8))
        self.chbxSelectAllLayers.setText(QtGui.QApplication.translate("MultiQmlForm", "Select all", None, QtGui.QApplication.UnicodeUTF8))
        self.chbxViewLayers.setText(QtGui.QApplication.translate("MultiQmlForm", "View", None, QtGui.QApplication.UnicodeUTF8))
        self.chbxTransparentLayer.setText(QtGui.QApplication.translate("MultiQmlForm", "Transnparent", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("MultiQmlForm", "Transparent\n"
"pixels:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("MultiQmlForm", "Full", None, QtGui.QApplication.UnicodeUTF8))
        self.lbTransparencyValuePercant.setText(QtGui.QApplication.translate("MultiQmlForm", "100%", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("MultiQmlForm", "None", None, QtGui.QApplication.UnicodeUTF8))
